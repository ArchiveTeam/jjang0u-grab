...
More information about the archiving project can be found on the ArchiveTeam wiki: [짱공유닷컴](https://wiki.archiveteam.org/index.php?title=짱공유닷컴)
...
We strongly encourage you to join the IRC channel associated with this project in order to be informed about project updates and other important announcements, as well as to be reachable in the event of an issue. The Archive Team Wiki has [more information about IRC](https://wiki.archiveteam.org/index.php/Archiveteam:IRC). We can be found at hackint IRC [#jjang0n](https://webirc.hackint.org/#irc://irc.hackint.org/#jjang0n).
...
after which the project container can be run:
    ...
    docker run -d --name archiveteam --label=com.centurylinklabs.watchtower.enable=true --log-driver json-file --log-opt max-size=50m --restart=unless-stopped atdr.meo.ws/archiveteam/jjang0u-grab --concurrent 1 YOURNICKHERE
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#jjang0n](https://webirc.hackint.org/#irc://irc.hackint.org/#jjang0n).
