...
LUA_SHA1 = get_hash(os.path.join(CWD, 'jjang0u.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'doc':
                board, doc = item_value.split(':', 1)
                wget_args.extend(['--warc-header', 'jjang0u-doc: '+item_value])
                wget_args.append('https://www.jjang0u.com/board/view/{}/{}'.format(board, doc))
            elif item_type == 'asset':
                url = 'https://' + item_value
                wget_args.extend(['--warc-header', 'jjang0u-asset: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/3/30/Jjang0u-icon.png" height="50px" title=""/>
        <h2>짱공유닷컴 <span class="links"><a href="https://jjang0u.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/jjang0u/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/짱공유닷컴">Wiki</a></span></h2>
        <p>Archiving 짱공유닷컴.</p>
    '''
)
